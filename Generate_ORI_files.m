...
%    euler_angle = RotationAngles(Rc)';
   euler_angle = rotm2eul(Rc,'XYZ');
   ...
   dlmwrite(file_name,0.1*1000,'-append','precision','%.3f') % BACK Focal distance should be in
   dlmwrite(file_name,[0.001 0.001 0.001],'-append','delimiter','\t','precision','%.3f') % Last line
