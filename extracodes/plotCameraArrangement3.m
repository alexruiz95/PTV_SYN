function plotCameraArrangement3(varargin)
...
ss=1.4;
plot3(ss*x(:),ss*y(:),ss*z(:), '.w', 'markersize', 8, 'markerfacecolor', 'w');
% Title
% title('Camera Arrangement',"Color",'white','fontsize', 14, 'interpreter', 'latex')
hold off;
axis image;
axis vis3d;
grid on;
