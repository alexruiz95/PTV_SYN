...
text(Xc1(1),Xc1(2),Xc1(3),strcat('X',axislabel),'Color',color)
text(Yc1(1),Yc1(2),Yc1(3),strcat('Y',axislabel),'Color',color)
text(Zc1(1),Zc1(2),Zc1(3),strcat('Z',axislabel),'Color',color)
